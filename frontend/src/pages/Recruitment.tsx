...
const modalBox: React.CSSProperties = { background: tk.bg2, border: '1px solid #333', borderRadius: 10, width: '100%', maxWidth: 580, maxHeight: '90vh', overflowY: 'auto', padding: '26px 30px' };
  ...
  return (
    <div style={{ color: '#FFF' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 20 }}>
        <div>
          <h1 style={{ fontSize: 24, fontWeight: 700, margin: 0 }}>Recruitment Pipeline</h1>
          <div style={{ width: 40, height: 3, background: tk.accent, borderRadius: 2, marginTop: 6 }} />
          <p style={{ fontSize: 12, color: '#555', marginTop: 6 }}>TBH (To-Be-Hired) code tracker</p>
        </div>
