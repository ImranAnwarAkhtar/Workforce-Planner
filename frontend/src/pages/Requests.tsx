...
const btnGreen: React.CSSProperties = { padding: '5px 12px', background: '#0D2B1E', color: '#33CC77', border: '1px solid #1A5E38', borderRadius: 4, fontSize: 12, fontWeight: 600, cursor: 'pointer' };
const btnRed: React.CSSProperties   = { padding: '5px 12px', background: '#2B0D0D', color: '#E31837', border: '1px solid #5E1A1A', borderRadius: 4, fontSize: 12, fontWeight: 600, cursor: 'pointer' };
